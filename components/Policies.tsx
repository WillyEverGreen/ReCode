      ...
      case 'privacy':
        return (
          <div className="space-y-6 text-gray-300">
            ...
            <p>
              ReCode provides tools for code analysis, complexity evaluation,
              and optimization to help developers write better software.
            </p>
            <p>
            ...
            <p>
              By using our services, you confirm that you meet this age
              requirement.
            </p>
            ...
            <h4 className="text-lg font-medium text-white mt-4">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Email address</li>
              <li>
                Profile information provided through GitHub or Google
                authentication
              </li>
            </ul>
            ...
            <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg text-yellow-200">
              ⚠️ Please do not submit confidential, sensitive, or proprietary
              code.
            </div>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Improve our analysis systems and user experience (using
                anonymized data)
              </li>
              <li>
                Communicate with you regarding updates, support, or important
                notices
              </li>
            </ul>

            <h3 className="text-xl font-semibold text-white mt-8">
              5. Code Submissions & Data Retention
            </h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>Code submitted to ReCode is processed securely.</li>
              <li>We do not sell or share your code with third parties.</li>
              <li>
                Code may be temporarily stored to perform analysis and
                debugging.
              </li>
              <li>
                Anonymized code patterns may be used to improve system accuracy.
              </li>
              <li>
                You should avoid submitting sensitive or proprietary code.
              </li>
            </ul>
            ...
            <p>
              We use trusted third-party services to operate ReCode, including:
            </p>
            <ul className="list-disc pl-5 space-y-2">
            ...
            <a
              href="mailto:noreply@recode.app"
      ...
      case 'terms':
        return (
          <div className="space-y-6 text-gray-300">
            ...
            <p>
              By accessing or using ReCode (“the Service”), you agree to be
            ...
            <p>
              ReCode grants you a limited, personal, non-exclusive,
              non-transferable, and revocable license to use the Service for
              personal learning, professional development, and educational
              purposes only, in accordance with these Terms.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Use ReCode to generate or submit plagiarized or academic
                dishonesty content
              </li>
            </ul>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ReCode does not guarantee correctness of explanations,
                solutions, or complexity analysis
              </li>
              <li>
                You are responsible for verifying outputs before relying on them
                in exams, interviews, or production systems
              </li>
              <li>
                <strong>Complexity Analysis Methodology:</strong> Currently, our
                Complexity Engine calculates the{' '}
                <strong>Worst-Case Time Complexity (Upper Bound)</strong> by
                default to ensure conservative safety estimates. We are actively
                working on future updates to provide detailed breakdown analysis
                for Best-Case, Average-Case, and Amortized scenarios.
              </li>
            </ul>
            ...
            <p>
              All content, branding, software, and AI systems provided by ReCode
              are owned by or licensed to ReCode and are protected by
              intellectual property laws.
            </p>
            <p>
              You may not copy, modify, distribute, or commercialize any part of
            ...
            <p>
              To the maximum extent permitted by law, ReCode shall not be liable
            ...
            <p>
              We reserve the right to suspend or terminate your access to ReCode
            ...
            <p>
              ...
              the official ReCode support channels.
            </p>
          </div>
        );
      ...
      case 'refunds':
        return (
          <div className="space-y-6 text-gray-300">
            ...
            <p>
              Due to the nature of our digital products (AI analysis services),
              we generally do not offer refunds once the service has been used.
            </p>
            <p>
              However, we may consider refunds in exceptional circumstances,
              such as:
            </p>
            <ul className="list-disc pl-5 space-y-2">
      ...
      case 'shipping':
        return (
          <div className="space-y-6 text-gray-300">
            ...
            <p>
              ReCode is a SaaS (Software as a Service) platform. We do not sell
              physical products.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Access to Pro features is granted <strong>immediately</strong>.
              </li>
            ...
            <p>
              If you do not receive access immediately after purchase, please
              log out and log back in, or contact support.
            </p>
          </div>
        );
            ...
            <div className="space-y-8 mt-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:noreply@recode.sbs"
    ...
    <div className="min-h-screen bg-[#0c0c0c] text-gray-100 font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-gray-800 bg-[#0c0c0c]/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 py-4 flex items-center justify-between">
          <div
            className="h-8 rounded-lg overflow-hidden cursor-pointer"
            onClick={onHome}
          >
            <img
              src={AppLogo}
