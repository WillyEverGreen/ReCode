            ...
            >
              ...
              <div className="relative bg-[#0F1420] rounded-2xl overflow-hidden border border-white/10 shadow-2xl text-left">
                ...
                <div className="flex items-center gap-2 px-3 sm:px-5 py-3 bg-[#0B0F19] border-b border-white/5">
                  ...
                  <span className="ml-3 text-[10px] sm:text-xs md:text-sm text-gray-500 font-mono truncate">
                ...
                <div className="px-4 py-8 md:px-10 md:py-10 font-mono text-sm md:text-base lg:text-lg overflow-x-hidden">
                  <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="flex gap-4">
                      <div className="text-gray-600 select-none w-6 text-right flex-shrink-0">
                        1
                      </div>
                    ...
                    <div className="flex gap-2 md:gap-4">
                      <div className="text-gray-600 select-none w-4 sm:w-6 text-right flex-shrink-0">
                        2
                      </div>
  ...
  const features = [
    {
      ...
      description:
        'AI breaks down your solution into clear, understandable patterns and approaches.',
    ...
    },
    {
      ...
      description:
        'Get time complexity, space complexity, and optimization suggestions in seconds.',
    ...
    },
    {
      ...
      description:
        'Auto-generated revision notes with edge cases, syntax tips, and test cases.',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Powerful features that transform how you prepare for coding
            interviews
          </p>
        </motion.div>
  ...
  const steps = [
    {
      ...
      description: 'Copy your LeetCode solution and paste it into ReCode',
    },
    {
      number: '02',
      title: 'AI Analyzes',
      description: 'Our AI breaks down your approach, complexity, and patterns',
    },
    {
      number: '03',
      title: 'Get Structured Notes',
      description: 'Receive clean, organized notes ready for revision',
    },
  ];
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="font-medium">
                  10 Get Solution + 10 Add Solution per day
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-yellow-400 flex-shrink-0 mt-0.5" />
...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    {
      quote:
        'ReCode transformed how I prepare for interviews. The AI insights are spot-on.',
      author: 'Sarah Chen',
      role: 'SDE @ Google',
    },
    {
      quote:
        'Finally, a tool that actually helps me understand my solutions, not just store them.',
      author: 'Alex Kumar',
      role: 'SDE @ Microsoft',
    },
    {
      quote:
        'The structured notes feature is a game-changer. I aced my Meta interview!',
      author: 'Jordan Lee',
      role: 'SDE @ Meta',
    },
  ];
...
const ProductPreviewSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-32 px-6 bg-gradient-to-b from-transparent to-white/[0.02] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Transform your LeetCode solutions into structured, AI-powered
            revision notes
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <div>
              ...
              <p className="text-gray-400 text-base lg:text-lg leading-relaxed">
                ReCode analyzes your code, identifies patterns, and generates
                comprehensive notes including approach, complexity analysis,
            ...
            <div className="space-y-4 lg:space-y-6">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-base lg:text-lg mb-1">
                      {feature.title}
                    </h4>
          ...
          >
            ...
            <div className="relative">
              ...
              <div
                className="relative rounded-2xl overflow-hidden border border-white/20 shadow-2xl backdrop-blur-sm"
                style={{ height: window.innerWidth < 1024 ? '400px' : '600px' }}
              >
                {screenshots.map((screenshot, index) => (
  ...
  const faqs = [
    {
      ...
      answer:
        'Our AI analyzes your code structure, identifies patterns, calculates complexity, and generates comprehensive notes including approach, tricks, edge cases, and test cases.',
    },
    {
      question: 'Can I use ReCode for free?',
      answer:
        'Yes! The free plan includes 1 Get Solution + 2 Add Solution analyses per day for 7 days. No credit card required. Perfect for trying out the platform.',
    },
    {
      question: 'What programming languages are supported?',
      answer:
        'ReCode supports all major programming languages including Python, JavaScript, Java, C++, and more. The AI is trained on diverse coding patterns.',
    },
    {
      question: 'How is this different from just saving code?',
      answer:
        "ReCode doesn't just store your code – it analyzes it, extracts key insights, identifies patterns, and creates structured revision notes that help you truly understand and remember solutions.",
    },
    {
      question: 'Can I export my notes?',
      answer:
        'Pro users can export their notes as PDF or Markdown files, making it easy to review offline or share with others.',
    },
  ];
