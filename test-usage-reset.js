...
console.log("🇮🇳 Next Reset Time (IST):", resetIST.toLocaleString('en-IN', { timeZone: 'Asia/Kolkata' }));
...
const mockUsageRecords = [
  { userId: "user123", date: "2025-12-26", getSolutionCount: 2, addSolutionCount: 3 },
  { userId: "user123", date: "2025-12-27", getSolutionCount: 1, addSolutionCount: 2 },
  { userId: "user123", date: "2025-12-28", getSolutionCount: 0, addSolutionCount: 0 },
];
...
mockUsageRecords.forEach((record, index) => {
  ...
  console.log(`  - Status: ${record.getSolutionCount === 0 ? '✅ Fresh limits' : '📊 Usage recorded'}`);
});
...
function simulateUsageCheck(userId, targetDate) {
  ...
  const record = mockUsageRecords.find(r => r.userId === userId && r.date === targetDate);
...
console.log(`   Get Solution: ${day1.getSolutionUsed}/${day1.getSolutionLimit} (${day1.getSolutionLeft} left)`);
console.log(`   Add Solution: ${day1.addSolutionUsed}/${day1.addSolutionLimit} (${day1.addSolutionLeft} left)`);
...
console.log(`   Get Solution: ${day2.getSolutionUsed}/${day2.getSolutionLimit} (${day2.getSolutionLeft} left)`);
console.log(`   Add Solution: ${day2.addSolutionUsed}/${day2.addSolutionLimit} (${day2.addSolutionLeft} left)`);
...
console.log(`   Get Solution: ${day3.getSolutionUsed}/${day3.getSolutionLimit} (${day3.getSolutionLeft} left)`);
console.log(`   Add Solution: ${day3.addSolutionUsed}/${day3.addSolutionLimit} (${day3.addSolutionLeft} left)`);
...
console.log(`⏱️  Time Until Reset: ${hoursUntilReset} hours (${Math.floor(hoursUntilReset)} hours ${minutesUntilReset} minutes)`);
